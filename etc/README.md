# sdkwork-discovery Source Configuration
...
| `runtimeCode` | `discovery` |
| Config root | `/etc/sdkwork/discovery/` |
| Runtime TOML | `/etc/sdkwork/discovery/config.toml` |
| Secrets | `/etc/sdkwork/discovery/secrets/` |
| Override | `SDKWORK_DISCOVERY_CONFIG_FILE` |
