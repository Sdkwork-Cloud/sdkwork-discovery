...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_discovery_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'discovery_', owner: 'discovery-platform', domain: 'discovery' }],
};
