...
-- baseline source: ddl/baseline/sqlite/0001_discovery_legacy_baseline.sql
...
-- folded migration: migrations/sqlite/0001_initial_discovery_schema.up.sql
CREATE TABLE IF NOT EXISTS discovery_revision_counter (
    id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    uuid TEXT NOT NULL,
    namespace TEXT NOT NULL,
...
-- folded migration: migrations/sqlite/0002_add_health_check_columns.up.sql
